...
namespace Clr2Jvm.Interop.Reflection
{
    ...
    /// </summary>
    readonly struct JavaFieldDescriptor
    {
        ...
        public static implicit operator JavaFieldDescriptor(string s) => Parse(s);
        public static implicit operator string(JavaFieldDescriptor s) => s.ToString();
        ...
        /// <returns></returns>
        public static JavaFieldDescriptor Parse(ReadOnlySpan<char> signature)
        {
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public static JavaFieldDescriptor Parse(ReadOnlySpan<char> signature, out int i)
        {
            // start at beginning
            i = 0;
            ...
            return new JavaFieldDescriptor(p, t, r);
        }
        ...
        public JavaFieldDescriptor(JavaDescriptorType type, string clazz, int arrayRank)
        {
            if (arrayRank < 0)
